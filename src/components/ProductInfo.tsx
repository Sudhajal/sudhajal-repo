        ...
        <div className="flex flex-col max-w-full w-[973px]">
          ...
          <nav className="flex gap-2.5 self-start mt-6 text-xl">
            ...
            <div className="flex gap-1.5">
              ...
              <img
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/f0dc0bf5e20c68179a11bfff0a5e76372f54edd7ce1f8fc95b2c0aa9c412f1ee?placeholderIfAbsent=true&apiKey=bc78d96b1bfe4229ab8bdab79a935f37"
                className="object-contain shrink-0 my-auto w-5 aspect-square"
                alt=""
              />
          ...
          <div className="flex flex-col w-[41%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col w-full max-md:mt-5 max-md:max-w-full">
              <div className="flex overflow-hidden flex-col justify-center items-center px-14 bg-white rounded-3xl border border-sky-500 border-solid aspect-square shadow-[0px_3px_25px_rgba(0,173,237,0.3)] max-md:px-5 max-md:mr-1">
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/f80cb997f6a437237e30ff68c1cddf9fff8a66197a97b99f8ddd5073804a2b48?placeholderIfAbsent=true&apiKey=bc78d96b1bfe4229ab8bdab79a935f37"
              ...
              <div className="flex gap-2 mt-3 text-xs text-black whitespace-nowrap">
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/b4d3504ab7b6bbc7442ab5e8eff7be66a0106cddba76011423c9562be64c8de6?placeholderIfAbsent=true&apiKey=bc78d96b1bfe4229ab8bdab79a935f37"
